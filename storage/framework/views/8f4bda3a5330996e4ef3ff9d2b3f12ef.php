...
<i>Last updated on : 21-02-2019 12:03 PM</i>
	...
	<div>
		 <img src="<?php echo e(env('FILE_VIEW')); ?>/visitors/library.gif" alt="" class="img-responsive" style="margin-top:30px; margin-bottom:30px; height:200px; width:200px;">
	 	</div>
	</div>
